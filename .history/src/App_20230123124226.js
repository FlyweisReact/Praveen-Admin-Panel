...
import DriversBookings from "./AdminPanel/components/DriversBookings";
import Penalty from "./AdminPanel/components/Penalty";
  ...
  return (
    <> 
      <Routes>
        ...
        <Route path="/Driver/:id" element={<DriversBookings />} />
