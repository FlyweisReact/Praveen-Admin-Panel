...
//  All Drivers
  ...
  const ViewAllDriver = async () => {
    try {
      const {data} = await axios.get('http://ec2-15-206-210-177.ap-south-1.compute.amazonaws.com:3003/api/admin/allDrive');
      setDriverdata(data);
    } catch (e) {
      ...
      <table class="table">
        ...
        <tbody>
          {driverdata?.driver?.map((item , index) => (
            <tr key={index}>
              <td>
                <img src={item.image ? item.image : "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQ6pg7njRUvR2n1O3mGUrm8EgSU56yP5LsSxg&usqp=CAU"}  alt="" style={style} />
              </td>
              <td>{item.name}</td>
              ...
              <td>
                ...
                <button
                  onClick={() => navigate("/Edit-driver", { state: item })}
                  style={{
                    margin: "0 10px",
                    border: "none",
                    cursor: "pointer",
                    backgroundColor: "#54ef9c",
                    color: "#fff",
                  }}
                >
                  Edit
...
data:image/jpeg;base64,              
          ...
          <Typography gutterBottom>Driver Name : Mr. d</Typography>
          <Typography gutterBottom>Mobile No : +91 600567890</Typography>
        </DialogContent>
        <DialogActions>
