...
const Driver = () => {
  ...
  function AddWallet(props) {
    ...
    const AddMoney = async () => {
      try{
        const data = await axios.put(`ec2-15-206-210-177.ap-south-1.compute.amazonaws.com:3003/api/admin/drivers/wallet/${id}` , {
          balence
        })
        alert('Balance Added')
        console.log(data)
          ...
          <Container>
            <Form onSubmit={AddMoney}>
              <Form.Group className="mb-3">
                ...
                <Form.Control type="number" onChange={(e) => setBa} />
              </Form.Group>
